...
public class RedisUtils<T> {
    ...
    private  final RedisTemplate<String, T> redisTemplate = SpringContextHelper.getBean("redisTemplate");

    public static <T> RedisUtils<T> use(){
        return new RedisUtils<T>();
    }
     ...
     * @return
     */
    public void remove(String key, T... values) {
     ...
     * @return
     */
    public void rightPushIfPresent(String key, T value) {
